...
int main()
{
	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			// {
			// 	case my::ScreenType::StartMenu: {

			// 		RectangleShape collider = Mbuttons[static_cast<int>(my::Screen::currentScreen)].btns[0]; //butonul de createImage
			...
			// 		RectangleShape rectangleBtn = Mbuttons[static_cast<int>(my::Screen::currentScreen)].btns[0];
			// 		RectangleShape circleBtn = Mbuttons[static_cast<int>(my::Screen::currentScreen)].btns[1];
			// 		RectangleShape triangleBtn = Mbuttons[static_cast<int>(my::Screen::currentScreen)].btns[2];
			...
			// 				my::ShapeSelector::movingShape = my::ShapeSelector::selectedShape;
			...
			// 		switch (my::ShapeSelector::movingShape) //aici se misca obiectul
			// 		{
			// 			case my::ShapeType::Rectangle: {
			// 				if (Mouse::isButtonPressed(Mouse::Left))
			// 				{
