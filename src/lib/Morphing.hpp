...
private:
	...
	static void animateCircle(sf::RenderWindow& window, sf::CircleShape& circle, sf::Vector2u finalPoint, float progress, bool& isFinished);
	static void animateRectangle(sf::RenderWindow& window, sf::RectangleShape& rectangle, sf::Vector2u finalPoint, float progress, bool& isFinished);
